...
public class LazyLoadWrapperDemo implements Serializable {
    ...
    LazyLoadWrapper llw;
    LegacyWindow allFeaturesWindow, mainWindow, loadExampleNoWrapper,
    ...
    public LazyLoadWrapperDemo() {

    }

    public Window createDemo() {

        mainWindow = new LegacyWindow("Lazy load wrapper v." + version);
        ...
        Label heading = new Label("Lots of loprem... ");
        ...
        mainPanelLayout.addComponent(hl);
        ...
        Button launchHeavyAppNoWrapperExample = new Button(
                ...
                new Button.ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        ...
                        UI.getCurrent().addWindow(loadExampleNoWrapper);
                    }
        ...
        mainPanelLayout.addComponent(selectors1);
        ...
        Button launchHeavyAppWithWrapperExample = new Button(
                ...
                new Button.ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        ...
                        UI.getCurrent().addWindow(loadExampleWithWrapper);
        ...
        mainPanelLayout.addComponent(selectors2);
    ...
    private void heavyAppLaunchExample(int heaviness, boolean useWrapper,
        ...
        if (useWrapper) {
            loadExampleWithWrapper = new LegacyWindow(
            ...
            loadExampleNoWrapper = new LegacyWindow(
        ...
        text.setContent(textLayout);
        textLayout.setWidth("1250px");
        textLayout.setHeight("1250px");
        textLayout
        ...
        VerticalLayout tableAndIDF = new VerticalLayout();
        ...
        if ((heaviness / 4) > 0) {
            ...
            for (int i = 0; i < (heaviness / 4); i++) {
                for (int j = 0; j < 4; j++) {
                    ...
                    morePanels[(i * 4) + j].setContent(vlx);
                    vlx.addComponent(new HeavyComponent());
                    if (useWrapper) {
                        LazyLoadWrapper llw = new LazyLoadWrapper(
    ...
    // //
    //
    // gl.addComponent(createClientSideOnly(defProximity, defVisibleDly), 0, 5);
    ...
    // }
    //
    // private Component createBasicExpandExample(int proximity, int
    // visibleDelay) {
    //
    ...
    // }
    //
    // private Component createServerSideLazyLoad(int proximity, int
    // visibleDelay) {
    // Label desc = new Label(
    ...
    // }
    //
    public static class LegacyWindow extends Window {

        private VerticalLayout mainLayout;

        public LegacyWindow(String name) {
            setCaption(name);
        }
